...
export default function Footer() {
    return (
        <footer className="w-full py-2 md:py-6 flex flex-col items-center gap-2 bg-transparent z-50 relative">
            <a
            ...
            >
                <Linkedin className="w-8 h-8 md:w-20 md:h-20" strokeWidth={0.8} />
            </a>
