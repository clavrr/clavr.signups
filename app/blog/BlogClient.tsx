...
export default function BlogClient({ initialPosts }: BlogClientProps) {
    ...
    // Data State
    // We start with the passed initialPosts, but keep state in case we want to support
    // client-side updates later (though currently we just rely on props)
    const [posts] = useState<Post[]>(initialPosts);
    // Since we're passing data from the server, loading is theoretically instant for the initial render
    ...
    useGSAP(() => {
        function goToGroup(direction: number) {
            ...
            // Safety check in case elements aren't mounted yet
